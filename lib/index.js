...
function isOverflow(node, parent) {
  return parent !== node.ownerDocument && parent !== document && parent !== document.documentElement;
}
...
var checkVisible = function checkVisible(component) {
  ...
  var visible = isOverflow(node, parent) ? checkOverflowVisible(component, parent) : checkNormalVisible(component);
...
var LazyLoad = function (_Component) {
  ...
  _createClass(LazyLoad, [{
    ...
    key: 'setupListeners',
    value: function setupListeners(node) {
    ...
    value: function teardownListeners(node) {
      var parent = (0, _scrollParent2.default)(node);
      if (this.props.overflow && parent && isOverflow(node, parent)) {
